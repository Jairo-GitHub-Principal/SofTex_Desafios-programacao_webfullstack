...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Soma Maxima");
			...
			valoresDoVetorPrincipal = new int[tamanhoDovetorPrincipal];
			...
			for(int i = 0; i < tamanhoDovetorPrincipal;i++) {
				...
				valoresDoVetorPrincipal[i]=entrada.nextInt();
			}
	...
	System.out.println("\n informe o tamanho do sub vetor");
			...
			int result =  somamaxSubVet.SomaMaximaSubVet(tamanhoDoSubVetor,valoresDoVetorPrincipal);
